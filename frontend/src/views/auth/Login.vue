  ...
  <div class="auth-shell">
    ...
    <div class="brand-panel">
      <div class="brand-inner">
        ...
        <p class="brand-sub">项目管理的<br />极简解法</p>
        <div class="brand-tags">
          <span class="tag">// 问题追踪</span>
          <span class="tag">// 看板视图</span>
    ...
    <div class="form-panel">
      <div class="form-inner">
        <div class="form-header">
          <p class="form-label">[ 身份验证 / LOGIN ]</p>
...
.brand-panel {
  ...
  &::before {
    ...
    inset: 0;
    background:
      radial-gradient(ellipse 70% 50% at 20% 70%, rgba(212, 135, 10, 0.18) 0%, transparent 65%),
      radial-gradient(ellipse 50% 40% at 80% 15%, rgba(212, 135, 10, 0.08) 0%, transparent 60%);
    pointer-events: none;
  }
}
